...
<section class="container pt-30">
    <div style="background: linear-gradient(45deg, var(--color-primary), var(--color-secondary))"
        class="rounded-xl p-5 flex flex-col items-center gap-5 md:flex-row md:justify-between">
        <div class="flex items-start gap-5">
            <span class="flex p-3 bg-white/30 rounded-xl w-fit">
            ...
            <div class="flex flex-col items-start gap-1">
                <h3 class="text-white font-bold text-lg">Get Your Premium Email Account</h3>
                <p class="text-white text-sm">join thousands of customers today.</p>
            </div>
        </div>
        <a href="#" class="flex rounded-xl py-2 px-3.5 bg-white text-sm text-secondary font-semibold leading-6 gap-2 w-fit">
            Browse Accounts
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 stroke-secondary">
...
<footer class="mt-20 pt-15 bg-cart-bg shadow-lg">
    <div class="container flex flex-col gap-15">
        <div class="grid gap-8 items-start md:grid-cols-[2fr_1fr_1fr_1fr]">
            <div class="flex flex-col gap-5 items-center">
                <a href="#" class="select-none flex items-center gap-1">
                    <img class="w-15" src="<?php echo home_url('wp-content/uploads/2026/06/logo.png') ?>" alt="">
                    <div class="font-bold text-xl dark:text-white">Novix<span class="text-primary">mail</span></div>
                </a>
                <p class="text-text-secondary leading-8 text-center">
                    Your trusted sourse for premium email accounts, We provide reliable, source, and high quality accounts for your business and personal needs
                </p>
                <div class="flex items-center gap-5">
                    <a href="#" class="flex border border-border rounded-md p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 71 72" fill="currentColor">
                    ...
                    <a href="#" class="flex border border-border rounded-md p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 71 72" fill="currentColor">
                            <path d="M33.2808 13.0437C25.8492 13.893 18.4439 20.0479 18.1382 28.84C17.9461 34.2083 19.435 38.2356 24.4258 39.3664C26.5915 35.4553 23.7272 34.5927 23.2818 31.7633C21.4523 20.1686 36.346 12.2615 44.14 20.3563C49.5324 25.9615 45.9826 43.206 37.2848 41.4136C28.9537 39.7017 41.3629 25.9749 34.713 23.2796C29.3074 21.0894 26.4343 29.9798 28.9974 34.396C27.4953 41.9902 24.2599 49.1464 25.5698 58.6715C29.8183 55.5158 31.2504 49.4727 32.425 43.1702C34.5601 44.4978 35.6998 45.8789 38.4244 46.0935C48.4714 46.8891 54.0822 35.8263 52.7112 25.6218C51.4929 16.5749 42.6729 11.971 33.2808 13.0437Z" # />
                        </svg>
                    </a>
                </div>
            </div>
            <div class="flex flex-col gap-5 mt-[5px]">
                <h5 class="font-bold text-lg text-center">Quick Links</h5>
                <ul class="flex flex-col gap-2 items-center">
                    <li><a href="<?php echo home_url() ?>" class="text-text-secondary text-sm">Home</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">Accounts</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">Features</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">FAQ</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">Contact</a></li>
                </ul>
            </div>
            <div class="flex flex-col gap-5 mt-[5px]">
                <h5 class="font-bold text-lg text-center">Account</h5>
                <ul class="flex flex-col gap-2 items-center">
                    <li><a href="#" class="text-text-secondary text-sm">Log in</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">Sign up</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">My Orders</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">Support</a></li>
                </ul>
            </div>
            <div class="flex flex-col gap-5 mt-[5px]">
                <h5 class="font-bold text-lg text-center">Legal</h5>
                <ul class="flex flex-col gap-2 items-center">
                    <li><a href="#" class="text-text-secondary text-sm">Terms of Service</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">Privacy Policy</a></li>
                    <li><a href="#" class="text-text-secondary text-sm">Refund Policy</a></li>
                </ul>
            </div>
        </div>
        <div class="text-center border-t border-border py-5 text-sm">@ 2026 <?php echo get_bloginfo('name'); ?> All rights reserved.</div>
    </div>
</footer>